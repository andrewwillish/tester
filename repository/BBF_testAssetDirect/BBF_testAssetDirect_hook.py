...
import imp
import os
import BBF_testAssetDirect_core
...
def initializePlugin(mobject):
    ...
    cmds.menuItem('asd_GEN_core',l='Asset Direct',p='toolsMainMenu', c=lambda*args:BBF_testAssetDirect_core.mainUI())       
    return

# Uninitialize the script plug-in
def uninitializePlugin(mobject):
    # delete this plugin menu first
    cmds.deleteUI('asd_GEN_core')
